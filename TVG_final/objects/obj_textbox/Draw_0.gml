...
if setup == false
{
	show_debug_message("Inside setup if block " + string(page_number) );
	setup = true;
	...
	for(var p = 0; p < page_number; p++)
	{
		...
		show_debug_message("SETTTING X OFFSET");
		text_x_offset[p] = 384;
		...
		show_debug_message("text x offset is " + string(text_x_offset[p]));
