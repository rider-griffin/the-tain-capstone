...
function scr_game_text(_text_id) {
	...
	//CH 6 cases 
		case "From Finnabair Chuailnge to Conaille":
			scr_text("Watch Medb and Fergus today for me. I don’t know why they are so intimate and I want you to find me some sign.", "Ailill", -1);
			scr_text("Well indeed, here is your sign. I discovered them sleeping together as you thought.", "Cuillius", -1);
			scr_text("Fair enough. It is all right. She is justified. She does it to keep his help on the Tain.", "Ailill", -1);
			scr_text("Cuillius drew Fergus’s sword out of tis sheath, leaving the sheath empty");
			scr_text("This is terrible. The wrong I have done Ailill. Wait here I must go into the wood. Don’t be surprised if I am gone a while.", "Fergus", -1);
