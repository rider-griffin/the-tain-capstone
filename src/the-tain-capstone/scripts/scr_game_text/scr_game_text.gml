...
function scr_game_text(_text_id) {
	...
	switch(_text_id) {
		...
		case "The tain bo cuailnge begins":
			...
			scr_text("It can't be true. Conchobor is suffering his pangs in Emain with all the rest of the Ulster warriors. My messengers have come from there nd told me. Fedelm, prophetess; how seest thou our host?" , "Medb - angry" , -1);
