...
ds_menu_main = create_menu_page(
	["Start Game", menu_element_type.page_transfer, menu_page.game],
...
menu_pages[1] = ds_menu_game;
menu_pages[2] = ds_settings;
menu_pages[3] = ds_menu_audio;
menu_pages[4] = ds_menu_difficulty;
menu_pages[5] = ds_menu_graphics;
//menu_pages[6] = ds_menu_controls;
